...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="privacy-policy-container px-8 py-12 max-w-5xl mx-auto ">
      <h1 className="text-4xl font-bold mt-6 text-center">Privacy & Policy</h1>

      <section className="mt-8">
        <h2 className="text-2xl font-semibold mb-4">1. Introduction</h2>
        <p className="text-gray-700 leading-7">
          Welcome to Car Hub! We are committed to safeguarding your privacy.
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-7">
          We collect various types of information to provide better services to
          all our users. This includes:
        </p>
        <ul className="list-disc list-inside mt-4 text-gray-700 leading-7">
          ...
          <li>
            Payment information for processing transactions, handled securely by
            third-party payment processors.
          </li>
          <li>
            Browser and device information collected through cookies and
            analytics tools.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside mt-4 text-gray-700 leading-7">
          ...
          <li>
            To communicate with you, including sending booking confirmations and
            updates.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside mt-4 text-gray-700 leading-7">
          <li>
            Trusted partners and service providers who assist in operating our
            website.
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-7">
          ...
          user experience, analyze traffic, and understand visitor behavior. You
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-7">
          ...
          contact us at support@carhub.com.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-7">
          ...
          be posted on this page, and we encourage you to review the policy
          periodically.
        </p>
      </section>
